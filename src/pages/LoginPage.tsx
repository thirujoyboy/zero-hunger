...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const dashboardPath = data.user.role === 'donor' ? '/donor-dashboard' 
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 bg-emerald-50/30">
      <motion.div
        ...
        className="w-full max-w-md bg-white p-8 rounded-3xl shadow-xl shadow-emerald-100 border border-emerald-50"
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">Log in to your Zero Hunger account</p>
        </div>
