            ...
            {user ? (
              <>
                ...
                >
                  ...
                  <span className="hidden sm:block text-sm font-medium text-emerald-800 truncate max-w-[80px] lg:max-w-[150px]">{user.name}</span>
                  <span className="text-[9px] sm:text-[10px] uppercase tracking-wider text-emerald-500 font-bold">{user.role}</span>
                </Link>
                <button
